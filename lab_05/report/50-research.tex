...
\par\textbf{Вывод} 
\par В данном разделе были рассмотрены результаты работы программы, стало ясно, что первый этап - шифрование шифром Цезаря замедляет работу всей системы, а также, что разница во времени работы 2 и 3 этапов крайне низка, что следует из низкого времени, проведенного в 3-ей очереди.
